...
autocmd filetype ruby nnoremap <buffer> <leader>d *N:silent grep 'def <c-r>/' -r .<cr>:redraw!<cr>
autocmd filetype ruby vnoremap <buffer> <leader>d "zy/<c-r>z<cr>N:silent grep 'def <c-r>/' -r .<cr>:redraw!<cr>
